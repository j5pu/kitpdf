...
def pdf_reduce(
    ...
    Examples:
        ...
        Path('.../pdfbox/data/tests/5.2M.pdf')
...
def pdf_scan(file: Path, directory: Path | None = None) -> Path:
    ...
    Examples:
        ...
        >>> from pdfbox import PDFBOX_DATA
        >>> from pdfbox import PDFBOX_DATA_TESTS
        >>> from pdfbox import SCAN_PREFIX
        >>> from pdfbox import pdf_scan
        >>>
